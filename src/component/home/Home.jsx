  ...
  style={{
    ...
    <div className=" p-4 sm:p-6 md:p-8 md:mx-5 lg:p-10 xl:p-4">
      <div className="text-center mx-2 w-auto sm:mx-4 md:mx-6 lg:mx-8 xl:mx-4">
        <h1 className="text-base sm:text-sm md:text-lg font-sans lg:text-3xl xl:text-3xl 2xl:text-3xl main mx-0  lg:mx-20 font-bold text-[#200899] border-b border-[#200899]  mb-4 pb-2">
      ...
      <div className="flex flex-col justify-center items-center font-sans  text-[#200899] mx-2 sm:mx-4 md:mx-6 lg:mx-12 xl:mx-12">
        <p className="text-[0.95rem]  text-justify lg:text-center pt-2 mb-4 sm:mb-6 md:mb-6 lg:mb-6 leading-relaxed xl:mb-8">
